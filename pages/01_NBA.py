...
repo_root = Path(__file__).resolve().parents[1]  # one level up from pages/
if str(repo_root) not in sys.path:
    sys.path.insert(0, str(repo_root))

# Import streamlit and set page config BEFORE any other Streamlit calls/imports
import streamlit as st

# MUST be the first Streamlit API call in this module
st.set_page_config(title="NBA Player Prop Tracker", layout="wide")

# Now safe to import other libraries and local modules
import logging
...
from app.utils import parse_players  # safe: utils.py does not import streamlit

# --- Rest of the page implementation (example) -------------------------------
